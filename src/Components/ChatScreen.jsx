    ...
    <div className="h-screen bg-white p-12 flex flex-col items-center">
      ...
      <div className="w-full bg-[#f3f5f5] min-h-[95%] rounded-4xl flex flex-col justify-between items-center p-10">
        ...
        <div className="bg-white p-4 max-w-7xl rounded-2xl">
          ...
          <div className="py-3 mt-4 bg-white border-t border-gray-200 flex items-center space-x-2">
            <input
              type="text"
            ...
            <button
              ...
              className="bg-[#FFA92F] hover:bg-[#FFCC85] transition-all text-white flex justify-center items-center rounded-4xl w-28 h-14"
            >
